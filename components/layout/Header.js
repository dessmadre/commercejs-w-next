...
export default function Header() {
	...
	return (
		<nav className='px-6 md:px-24 flex items-center flex-1 bg-gray-100 w-screen fixed z-50'>
			...
			<Cart
				...
				} absolute w-full lg:w-3/5 py-5 px-6 bg-gray-100 right-0 lg:right-24 mt-20 z-20 shadow-xl transition-all ease-in duration-700`}
			/>
		</nav>
	);
}
